...
class Authentication {
  ...
  static void addUserToDB(String userId, String email, String username) {
    ...
    snapShot.doc(userId).set({
      'email': email,
      'username': username,
      'profile_picture':'https://firebasestorage.googleapis.com/v0/b/chat-app-dc281.appspot.com/o/profile_pictures%2FpersonLogo.jpg?alt=media&token=cef46837-a270-472b-8f8e-658e5775a233',
      'user id' : userId
          });
  }
}
