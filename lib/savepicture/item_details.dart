...
import '../component/listrecomaninitem.dart';
...
class _ItemDetailsState extends State<ItemDetails>
  ...
  Future<void> tinhtrangphong() async {
    await FirebaseFirestore.instance
        .collection('Post')
        .doc(widget.itemId)
        .update({'tinh trang phong': 'Đã Được Đặt'});
  }
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            TextFormField(
                                                                              ...
                                                                              decoration: const InputDecoration(border: UnderlineInputBorder(), hintText: 'HỌ VÀ TÊN', hintStyle: TextStyle(color: Colors.grey)),
                                                                              validator: (value) {
                                                                            ...
                                                                            TextFormField(
                                                                              ...
                                                                              decoration: const InputDecoration(border: UnderlineInputBorder(), hintText: 'Nhập số điện thoại của bạn', hintStyle: TextStyle(color: Colors.grey, fontSize: 14)),
                                                                              validator: (value) {
                                                                                if (value!.isEmpty) {
                                                                            ...
                                                                            Container(
                                                                                ...
                                                                                child: ElevatedButton(
                                                                                  onPressed: () async {
                                                                                    ...
                                                                                    if (data['tinh trang phong'] == 'Còn Phòng' && userId != _auth.currentUser!.uid) {
                                                                                      if (_formKey.currentState!.validate()) {
                                                                                        if (hovaten == '' || sdt == '' || _dateController == '') {
                                                                                          hasNullValue = true;
                                                                                          ...
                                                                                          await Reservation.doc(widget.itemId)
                                                                                              ...
                                                                                              .whenComplete(() => tinhtrangphong().whenComplete(() => Navigator.of(context).pop()));
                                                                                        }
                                                                                      }
                                                                                    } else {
                                                                                      Fluttertoast.showToast(
                                                                                        msg: 'Xin Lỗi Bạn Không Thể Đặt Phòng Này Được',
                                                                                        toastLength: Toast.LENGTH_SHORT, // hoặc Toast.LENGTH_LONG
                                                                                        gravity: ToastGravity.BOTTOM, // vị trí hiển thị (TOP, CENTER, BOTTOM)
